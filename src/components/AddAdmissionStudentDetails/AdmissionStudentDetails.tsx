...
import { TextField, Button, Container, Card, Typography, Grid } from '@mui/material';
...
import { AddStudentDetailsCDA, GetStudentDetails } from 'src/requests/AddStudentDetails/RequestAddStudentDetails';
    ...
    <Container>
      ...
      <Card>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField value={age} type="text" onChange={(e) => handleChange(e)} label={'Age'} />
